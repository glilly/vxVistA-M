...
PRE ;PATCH 133 PRE-INSTALL ROUTINE
 ...
 .I $$VFILE^DILFD(162.02)>0,$$VFIELD^DILFD(162.02,FLD)>0 D
...
POST ;
 ...
 N M S M(1)="  ",M(2)=" This part of the post-install will be queued, but may "
 S M(3)=" take some time to run. It loops through the FEE BASIS PAYMENT "
 S M(4)=" file and removes any data that existed in the fields being moved "
 S M(5)=" to a different location within FEE BASIS PAYMENT."
 S M(6)=" The fields being deleted and re-added in a new location are: "
 S M(7)=" Fields: 59,60,61,62,63,64,65,66,67,68,69,76,77,78,79"
 D MES^XPDUTL(.M)
