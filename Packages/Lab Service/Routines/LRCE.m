LRCE ;DALOI/JMC - LOOK-UP ON CENTRAL ENTRY # ;03/24/11  17:32
 ;;5.2;LAB SERVICE;**28,76,103,121,153,210,202,263,350**;Sep 27, 1994;Build 7
 ;
EN ;
...
HEAD ;
 ...
 I $G(VA("MRN"))]"" D
 .W !!,"ORDER #: ",LRORD,?18,"PAT: ",PNM,?50,$G(VA("MRN",0))_": ",SSN
 .W !,?50,"DOB: ",$P($G(VADM(3)),U,2),!
 E  W !!,"ORDER #: ",LRORD,?20,"PAT: ",PNM,"    SSN: ",SSN,!
 ;DSS/RAF - END MOD
 D CHKPAGE
 Q:$G(LRSTOP)
 D LRGLIN^LRX
