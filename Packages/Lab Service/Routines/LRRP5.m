...
PROCESS ;For ea. specimen on date selected
 ...
 .;DSS/RAF - BEGIN MOD to add DFN as the 4th piece to be used in LRRP5A report
 .;S ^TMP($J,"PAT",LRPAT,LRSSN,LRORD,LRCS1,0)=LRTNN_U_LRLOC_U_LRCLCTD
 .I $T(VX^VFDI0000)]"",$$VX^VFDI0000["VX" D
 ..S ^TMP($J,"PAT",LRPAT,LRSSN,LRORD,LRCS1,0)=LRTNN_U_LRLOC_U_LRCLCTD_U_$G(DFN)
 .E  S ^TMP($J,"PAT",LRPAT,LRSSN,LRORD,LRCS1,0)=LRTNN_U_LRLOC_U_LRCLCTD
 .;DSS/RAF - END MOD
 Q
CNTSUM ;
