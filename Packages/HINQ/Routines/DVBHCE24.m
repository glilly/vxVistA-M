...
X11 D POW^DVBHUTIL
 Q
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW=".52;5",DV="SX",DU="",DLB="POW STATUS INDICATED?",DIFLD=.525
 S DE(DW)="C12^DVBHCE24",DE(DW,"INDEX")=1
...
X23 I '$D(DVBEI) S Y="@50",JP=JP+1
 Q
24 D:$D(DG)>9 F^DIE17 G ^DVBHCE27
