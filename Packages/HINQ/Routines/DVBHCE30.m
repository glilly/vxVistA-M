...
X5 I '$D(^DIC(31,JPP)) D CHKDIS^DVBHS3 S Y="@46"
 Q
6 S D=0 K DE(1) ;.3721
 S DIFLD=.3721,DGO="^DVBHCE31",DC="6^2.04P^.372^",DV="2.04MP31'X",DW="0;1",DOW="RATED DISABILITIES (VA)",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DIC(31,"
...
X32 S X=DVBOINC I X=""!(X=0) S X="@"
 Q
33 D:$D(DG)>9 F^DIE17 G ^DVBHCE32
