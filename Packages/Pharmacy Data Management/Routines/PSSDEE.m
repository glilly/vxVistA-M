...
ASK ;DSS/LM - Begin mods - Use VA PRODUCT : PRINT NAME as default DRUG name
 N VFDLAYGO,VFDNDA,VFDPPN S VFDPPN="" D VAPPN^VFDPSS S:$L(VFDPPN) DIC("B")=VFDPPN
 W ! S DIC="^PSDRUG(",DIC(0)="QEALMNTV",DLAYGO=50,DIC("T")="" D ^DIC K DIC I Y<0 S PSSFLAG=1 Q
 S VFDLAYGO=$P(Y,U,3) ;New entry
 ;DSS/LM - End mods
