PSSPOIM1 ;BIR/RTR,WRT-Manual create of Orderable Item continued ; 4/28/09 4:36pm
 ;;1.0;PHARMACY DATA MANAGEMENT;**29,38,47,141,153**;9/30/97;Build 7
 ;
...
SYN ;DSS/RAC -BEGIN MOD - Ask to copy SYNONYM entries from File 50
 I $T(VX^VFDI0000)'="",$$VX^VFDI0000["VX",$T(POSTPOI^VFDPSS)]"",$G(VFDLAYGO) D POSTPOI^VFDPSS
 ;DSS/RAC - END MOD 
