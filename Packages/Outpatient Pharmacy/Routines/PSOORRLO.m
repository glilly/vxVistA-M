PSOORRLO ;BHAM ISC/SJA - returns patient's outpatient meds-original sort ;10/12/06
 ;;7.0;OUTPATIENT PHARMACY;**225,331**;DEC 1997;Build 7
...
OCL ;entry point to return condensed list
 ...
 .;DSS/RAC - BEGIN MODS - add new condition when to expire, original code in else
 .I $T(VX^VFDI0000)'="",$$VX^VFDI0000["VX" D VFD^PSOORRL(7)
 .E  S ST0=$S(STA<12&($P(RX2,"^",6)<DT):11,1:STA)
 .;DSS/RAC - END MODS
