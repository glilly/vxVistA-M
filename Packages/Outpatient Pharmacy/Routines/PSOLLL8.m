PSOLLL8 ;BIR/JLC - LASER LABEL - CRITICAL INTERACTION ;12/13/02
 ;;7.0;OUTPATIENT PHARMACY;**120**;DEC 1997;Build 7
 ;
...
2 S PSOY=PSOY+PSOYI,T="This prescription has caused a DRUG-DRUG INTERACTION." D PRINT(T)
 ...
 ;DSS/SGM - BEGIN MODS - Conditionally remove VA-specific refernce,
 ;                       no patient status
 I $G(VFDPSOLB) D PSTAT^VFDPSOLB("LLL8") I 1
 E  S T="Pat. Stat "_PATST_" Clinic: "_PSCLN D PRINT(T)
 ;DSS/SGM - END MODS
 W @IOF
 I COPIES>0 G START
