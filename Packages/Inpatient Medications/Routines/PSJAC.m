PSJAC ;BIR/CML3-INPATIENT INFORMATION ;28 Apr 98 / 9:02 AM
 ;;5.0; INPATIENT MEDICATIONS ;**8,10,50,127**;16 DEC 97;Build 7
 ;
...
CNV ;
 ...
 ;DSS/SGM - BEGIN MOD  - Conditionally substitute MRN for SSN
 ;                       OSEHRA check: if VA("MRN") is valued
 I $G(VA("MRN"))'="" S VADM(2)=VA("MRN")_U_VA("MRN"),(VA("PID"),VA("BID"))=VA("MRN")
 ;DSS/SGM - END MOD
