PSBRPC ;BIRMINGHAM/EFC-BCMA RPC BROKER CALLS ;Mar 2004
 ;;3.0;BAR CODE MED ADMIN;**6,3,4,13,32,28**;Mar 2004;Build 153
...
USRLOAD(RESULTS,DUMMY) ;
 ...
 ;DSS/SGM - BEGIN MODS - pass flag for vxvista system or not
...
SCANPT(RESULTS,PSBDATA) ; Lookup Pt by Full SSN
 ...
 ; 
 N DFN
 ;DSS/SGM  - BEGIN MODS - modify for MRN lookup
 Q:$$VFD<0
 ;DSS/SGM - END MODS
