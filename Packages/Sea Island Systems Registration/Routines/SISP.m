SISP ;SIS/LM - Clone and optionally modify routine DGRP
...
EN1 I $G(DGRPV)=0 L +^DPT(DFN):3 E  D MSG Q
 ...
 S DGRPLAST=$$GET^XPAR("ALL","SIS REG LAST SCREEN NUMBER")
 S:'DGRPLAST DGRPLAST=5 ;Default last screen.  See also JUMP^SISPP1.
