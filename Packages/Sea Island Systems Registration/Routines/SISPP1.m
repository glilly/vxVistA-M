SISPP1 ;SIS/LM - Clone and optionally modify routine DGRPP1
...
JUMP ;jump screens (^N)
 ...
 ;S X=+$E(DGRPANN,2,99) I $D(DGRPVV(X)) S X1=$E(DGRPVV,$P(X,".")) I X1]"",'X1 G @$S(X=1.1:"^DGRPCADD",1:"^SISP"_X)
 S X=+$E(DGRPANN,2,99) I $D(DGRPVV(X)),'(X>DGRPLAST) S X1=$E(DGRPVV,$P(X,".")) I X1]"",'X1 G @$S(X=1.1:"^SISPCADD",1:"^SISP"_X)
 ...
 W !,*7 D W H 2
 G:DGRPS'=1.1 @("^SISP"_DGRPS) G:DGRPS=1.1 ^SISPCADD  ;return to same screen
 ;
