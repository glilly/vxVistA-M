GMVGETD2 ;HOIFO/YH-EXTRACT VITALS/MEASUREMENT RECORDS FOR A GIVEN DATE (CONT.) ;12/9/02  14:03
 ;;5.0;GEN. MED. REC. - VITALS;**1**;Oct 31, 2002;Build 153
 ;
...
SETLN ;CALLED BY GMVGETD1
 ...
 S:GMRVTY(1)="" GMRVTY(1)=$S(GMRVTY="LMP":"LMP: ",GMRVTY="EDD":"EDD: ",GMRVTY="LEN":"LEN: ",1:"")
 ...
 I "LMP^EDD"[GMRVTY S GMRVX=GMRVTY,GMRVX(0)=$P(GMRDAT,"^",8) D
 .S ^TMP($J,"GRPC",GJ)=^TMP($J,"GRPC",GJ)_$$FMTE^XLFDT(GMRVX(0),"5D")_" "
 .Q
 ; 2/16/2010 - Add LENGTH (LEN)
 I "LEN"[GMRVTY S GMRVX=GMRVTY,GMRVX(0)=$P(GMRDAT,"^",8) D
