DGRPXR ; GENERATED FROM 'DGRP COLLATERAL REGISTER' INPUT TEMPLATE(#422), FILE 2;05/20/09
 D DE G BEGIN
...
1 S DW="VET;1",DV="SX",DU="",DLB="VETERAN (Y/N)?",DIFLD=1901
 S DE(DW)="C1^DGRPXR"
 S DU="Y:YES;N:NO;"
 S X="N"
 S Y=X
...
C2F1 Q
X2 Q
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".32;3",DV="*P21'X",DU="",DLB="PERIOD OF SERVICE",DIFLD=.323
 S DE(DW)="C3^DGRPXR"
 S DU="DIC(21,"
