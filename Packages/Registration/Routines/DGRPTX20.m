...
X2 Q
3 S DQ=4 ;@53
4 S DW=".321;2",DV="SX",DU="",DLB="AGENT ORANGE EXPOS. INDICATED?",DIFLD=.32102
 S DE(DW)="C4^DGRPTX20"
...
X4 S DFN=DA D SV^DGLOCK
 Q
 ;
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW=".321;3",DV="SX",DU="",DLB="RADIATION EXPOSURE INDICATED?",DIFLD=.32103
 S DE(DW)="C5^DGRPTX20"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X5 S DFN=DA D SV^DGLOCK
 Q
 ;
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW=".322;13",DV="SX",DU="",DLB="SOUTHWEST ASIA CONDITIONS?",DIFLD=.322013
 S DE(DW)="C6^DGRPTX20"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X6 S DFN=DA D SV^DGLOCK
 Q
 ;
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW=".36;2",DV="SX",DU="",DLB="DISABILITY RET. FROM MILITARY?",DIFLD=.362
 S DE(DW)="C7^DGRPTX20"
...
X7 S DFN=DA D SV^DGLOCK
 Q
 ;
8 D:$D(DG)>9 F^DIE17,DE S DQ=8,DW=".3;1",DV="SX",DU="",DLB="SERVICE CONNECTED?",DIFLD=.301
 S DE(DW)="C8^DGRPTX20"
 S DU="Y:YES;N:NO;"
 G RE
...
X9 S:X'="Y" Y="@50"
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW=".3;2",DV="NJ3,0X",DU="",DLB="SERVICE CONNECTED PERCENTAGE",DIFLD=.302
