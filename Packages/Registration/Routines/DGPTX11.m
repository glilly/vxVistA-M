...
X2 S DGJUMP=$P(DGJUMP,"2,",2)
 Q
3 S DW="0;5",DV="P11'",DU="",DLB="MARITAL STATUS",DIFLD=.05
 S DE(DW)="C3^DGPTX11"
 S DU="DIC(11,"
 G RE
...
X9 S DGJUMP=$P(DGJUMP,"3,",2)
 Q
10 S DW=".321;1",DV="SX",DU="",DLB="VIETNAM SERVICE INDICATED?",DIFLD=.32101
 S DE(DW)="C10^DGPTX11"
...
X10 S DFN=DA D SV^DGLOCK
 Q
 ;
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW=".321;2",DV="SX",DU="",DLB="AGENT ORANGE EXPOS. INDICATED?",DIFLD=.32102
 S DE(DW)="C11^DGPTX11"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X12 S:X'="Y" Y=.32103
 Q
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".321;13",DV="SX",DU="",DLB="AGENT ORANGE EXPOSURE LOCATION",DIFLD=.3213
 S DE(DW)="C13^DGPTX11"
...
C13F1 Q
X13 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW=".321;3",DV="SX",DU="",DLB="RADIATION EXPOSURE INDICATED?",DIFLD=.32103
 S DE(DW)="C14^DGPTX11"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
