DGRPXC ; GENERATED FROM 'DG CONSISTENCY CHECKER' INPUT TEMPLATE(#421), FILE 2;05/20/09
 D DE G BEGIN
...
1 S DW=".36;1",DV="*P8'X",DU="",DLB="PRIMARY ELIGIBILITY CODE",DIFLD=.361
 S DE(DW)="C1^DGRPXC"
 S DU="DIC(8,"
 G RE
...
X4 S DFN=DA D AAC^DGLOCK2
 Q
 ;
5 S DW=".32;3",DV="*P21'X",DU="",DLB="PERIOD OF SERVICE",DIFLD=.323
 S DE(DW)="C5^DGRPXC"
 S DU="DIC(21,"
 G RE
