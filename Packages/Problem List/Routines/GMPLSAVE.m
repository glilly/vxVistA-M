GMPLSAVE ; SLC/MKB/KER -- Save Problem List data ; 11/13/2008
 ;;2.0;Problem List;**26,31,35,37,38**;Aug 25, 1994;Build 153
 ;
 ; External References
 ;   DBIA 10018  ^DIE
 ;   DBIA 10013  ^DIK
...
EN ; Save Changes made to Existing Problem
 ...
 ;DSS/LM  Add #21600.02
 F FLD=.01,.05,.12,.13,1.01,1.05,1.06,1.07,1.08,1.09,1.1,1.11,1.12,1.13,1.14,1.15,1.16,1.17,1.18,21600.01,21600.02 D
...
NEW ; Save Collected Values in new Problem Entry
 ...
 ;DSS/LM  Add #21600.02 - 3/16/2011
 S DATA=$P($G(GMPFLD(21600.02)),U) I DATA'="" S $P(^AUPNPROB(DA,21600),U,2)=DATA
 ;   Set X-Refs
