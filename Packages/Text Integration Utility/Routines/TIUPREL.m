TIUPREL ; GENERATED FROM 'TIU PRINT REL/UNV' PRINT TEMPLATE (#1350) ; 05/20/09 ; (FILE 8925, MARGIN=132)
 G BEGIN
CP G CP^DIO2
C S DQ(C)=Y
...
A1R ;
 ...
 W ?66 X DXS(1,9.2) S X1=DIP(1) X "S X=$$NAME^TIULS(X,X1)" K DIP K:DN Y W $E(X,1,15)
