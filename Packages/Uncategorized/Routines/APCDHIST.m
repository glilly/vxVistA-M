APCDHIST ; IHS/CMI/TUCSON - DISPLAY HIST. DATA ; [ 11/20/03  6:17 PM ]
 ;;2.0;IHS RPMS/PCC Data Entry;**2,3,7**;MAR 09, 1999
 ;
...
FHDSP S APCDTN=^AUPNFH(APCDTDFN,0)
 ...
 D GETNARR
 W APCDTDAT S APCDTICL=12 D PRTICD
 Q
 ;
...
PHDSP S APCDTN=^AUPNPH(APCDTDFN,0)
 ...
 ;
GETICDDX ;
 S:APCDTICF="L" APCDTICD=$P(^ICD9(APCDTICD,1),U)
 S:APCDTICF="S" APCDTICD=$P(^ICD9(APCDTICD,0),U,3)
 Q
GETICDOP ;
 S:APCDTICF="L" APCDTICD=$P(^ICD0(APCDTICD,1),U)
 S:APCDTICF="S" APCDTICD=$P(^ICD0(APCDTICD,0),U,4)
 Q
 ;
PRTICD ;
...
REF ;EP - called from [APCD REF] template to 
 ...
 .Q
 W !!,"Last of each refusal type documented in PCC for "_$P(^DPT(APCDPAT,0),U)_":",!
 ...
 .W !?5,"Refusal Type:  ",$$VAL^XBDIQ1(9000022,APCDX,.07)
 .Q
 W !
 Q
IMMCPT ;EP - called from APCD CPT templates
 NEW X S X=$P(^ICPT(APCDCPTP,0),U)
 I +X<90471 Q
 I +X>90749 Q
