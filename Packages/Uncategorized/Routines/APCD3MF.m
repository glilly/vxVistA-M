APCD3MF ; IHS/CMI/TUCSON - install and generate HL7 messages to 3M ; [ 01/16/01  1:42 PM ]
...
CHECKREC ;
 ...
 . ;file ICD9 code
 . S ICD9=$P(VPOV(APCDX),"^",3),ICD9=$O(^ICD9("AB",ICD9,0)) I ICD9="" S APCDERR="Could not find ICD9 code in table." Q
