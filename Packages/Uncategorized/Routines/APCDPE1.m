APCDPE1 ; IHS/CMI/TUCSON - DATA ENTRY ENTER MODE ; [ 02/27/01  2:39 PM ]
...
PROC1 ;********* loop through patients
 ...
 I $D(DIRUT) G EOJ
 I Y="C" D  G EOJ
 .D GETTEMP G:APCDTEMP="" EOJ  S APCDPEX=0 F  S APCDPEX=$O(^DIBT(APCDTEMP,1,APCDPEX)) Q:APCDPEX=""  S APCDPAT=APCDPEX D PROCESS
 .Q
