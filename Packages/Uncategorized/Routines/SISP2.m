SISP2 ;SIS/LM - Clone and optionally modify routine DGRP2
...
DGRP2 ;ALB/MRL,BRM - REGISTRATION SCREEN 2/CONTACT INFORMATION ;06 JUN 88@2300
 ...
 ; Comment-out [2] Previous (VA) Care, next two lines
 ...
 ; SIS/LM non-VA custom registration -
 ; 
 ; Item [2] 'Previous (VA) care' has been removed
 ; Item <4> 'Date of Death' is not editable
 ; Item [5] 'Emergency Katrina' will be bypassed (below)
 ; 
 S DGRPVV(2)="0101" ;Previous value was DGRPVV(2)="00010"
 G ^SISPP ;Skip [5] (VA-specific Hurricane Katrina item)
 ;
 ; End non-VA modification
