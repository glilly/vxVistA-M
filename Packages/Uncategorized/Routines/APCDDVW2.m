...
TXER ;EP;print transaction errors
 ...
 S APCDCL=0 F  S APCDCL=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOG",APCDCL)) Q:APCDCL'=+APCDCL!($D(APCDQUIT))  S APCDCLIN="" F  S APCDH=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOG",APCDCL,APCDCLIN)) Q:APCDCLIN=""!($D(APCDQUIT))  D
 ...
 S APCDCL=0 F  S APCDCL=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOGMAND",APCDCL)) Q:APCDCL'=+APCDCL!($D(APCDQUIT))  S APCDCLIN="" F  S APCDCLIN=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOGMAND",APCDCL,APCDCLIN)) Q:APCDCLIN=""!($D(APCDQUIT))  D
 ...
 Q
TXERD2 ;
 S (APCDFILE,APCDECNT)="" F  S APCDECNT=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOG",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT)) Q:APCDECNT=""  S APCDFILE=$P(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOG",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT),U,2) D TXERDW
 Q
TXER2 S (APCDFILE,APCDECNT)="" F  S APCDECNT=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT)) Q:APCDECNT=""  S APCDFILE=$P(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT),U,2) D TXERW
 Q
...
TXERD3 S (APCDFILE,APCDECNT)=""
 F  S APCDECNT=$O(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOGMAND",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT)) Q:APCDECNT=""!($D(APCDQUIT))  S APCDFILE=$P(^XTMP("APCDDV",APCDJOB,APCDBT,"TXER","DEMOGMAND",APCDCL,APCDCLIN,APCDH,APCDV,APCDECNT),U,2) D TXERDMW
 Q
 ;
