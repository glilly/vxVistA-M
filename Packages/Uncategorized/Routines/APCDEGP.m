APCDEGP ; IHS/CMI/TUCSON - group preventive services group form ; [ 06/19/02  10:38 AM ]
...
START ;
 ...
 Q
GETREST ;
 S APCDCLIN="" D GETCLN Q:'$D(APCDEGCL)  S APCDEGPR="" D PROV Q:APCDQUIT  S APCDPOV="" D POV Q:APCDQUIT
...
GETPAT ; GET PATIENT
 W !
 S APCDPAT=""
 S DIC="^AUPNPAT(",DIC(0)="AEMQ" D ^DIC K DIC,DA
 Q:Y<0
 I $D(APCDPARM),$P(APCDPARM,U,3)="Y" W !?25,"Ok" S %=1 D YN^DICN I %'=1 G GETPAT
 S APCDPAT=+Y
...
DISPLAY ;display all info and do you want to continue
 ...
 .I $P(^DD(9000010.06,.01,0),U,2)[200 W ?14,$P(^VA(200,Y,0),U),?46,$S(Z="P":"PRIMARY",1:"SECONDARY"),! Q
 ...
 .W ?10,$P(^ICD9(Y,0),U),?18,"Narrative: ",$P(^AUTNPOV(Z,0),U),!
