APCDRVH ; IHS/CMI/TUCSON - VISIT REVIEW HOSPITALIZATIONS ; [ 01/16/01  2:31 PM ]
...
SETPOV ;
 ...
 I APCDSC="P" S APCD3=APCD3+1,APCDPOV("P")=$P(^ICD9($P(APCDPREC,U),0),U)_"^"_$P(APCDPREC,U)_"^"_APCD2 Q
 S APCDPOV(APCDSC,APCD1)=$P(^ICD9($P(APCDPREC,U),0),U)_"^"_$P(APCDPREC,U)_"^"_APCD2
 Q
 ;
 ;
CHECKPVS ;
...
E1 ;CERTAIN CODES REQUIRE AN ACCEPT COMMAND
 I $D(^APCDINPT(8,11,"AC",$P(APCDPOV("P"),U))),'$D(APCDACC) D E1W
...
E11 ;CHECK SECONDARY FOR REQUIRED ACCEPT COMMAND/INVALID SECONDARY PVS
 I $D(^APCDINPT(8,11,"AC",$P(APCDPOV("S",APCD1),U))),'$D(APCDACC) D E1W
 Q
E1W ;
