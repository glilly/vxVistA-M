...
C8F1 N X,X1,X2 S DIXR=836 D C8X1(U) K X2 M X2=X D C8X1("O") K X1 M X1=X
 D
...
C8F2 Q
X8 Q
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,DW="0;5",DV="P11'",DU="",DLB="MARITAL STATUS",DIFLD=.05
 S DE(DW)="C9^IBXSC11"
 S DU="DIC(11,"
 G RE
...
X11 S:IBDR20'["14" Y="@15"
 Q
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW="VET;1",DV="SX",DU="",DLB="VETERAN (Y/N)?",DIFLD=1901
 S DE(DW)="C12^IBXSC11"
 S DU="Y:YES;N:NO;"
 G RE
...
C13S S X="" G:DG(DQ)=X C13F1 K DB
 D ^IBXSC16
C13F1 N X,X1,X2 S DIXR=840 D C13X1(U) K X2 M X2=X D C13X1("O") K X1 M X1=X
 D
