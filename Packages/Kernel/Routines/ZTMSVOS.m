%ZTMS ;SEA/RDS-TaskMan: Submanager, (Entry & Trap) ; 8/25/09 9:34am
 ;;8.0;KERNEL;**2,18,24,36,67,94,118,127,136,162,275**;Jul 10, 1995;Build 2
 ;
START ;Bottom level of submanager
 ; DSS/LM - Begin Mod - License Sharing
 D X^VFDXTX("SHARE LICENSE SLOTS (TASKMAN)")
 ; DSS/LM - End Mod - Cache License Sharing
