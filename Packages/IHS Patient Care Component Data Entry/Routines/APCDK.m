APCDK ; IHS/CMI/TUCSON - NIGHTLY AMBULATORY VISIT V FILE RELINKER ; [ 01/07/04  7:19 AM ]
 ;;2.0;IHS RPMS/PCC Data Entry;**2,6,7**;MAR 09, 1999
 ;
 ;
EN ;
 D ^APCDCHKJ ;run in hospital relinker to link I's to H's
 D ^APCDKDTC ;dtc relinker
 S X1=DT,X2=-61 D C^%DTC S APCDK("DATE")=X_.999999
 S U="^",(APCDK("VISITS"),APCDK("RELINK"))=0
...
EOJ ;
 ...
 S:$D(ZTQUEUED) ZTREQ="@"
 K APCDKV,APCDKNV,APCDKMM,APCDKVFL,APCDKVDG,APCDKIGR,APCDVDFN,APCDK12N,APCDK,APCDKX,APCDKDSP,APCDKHI,APCDKPAT,APCDKAVD,APCDKAVC,APCDKVCT,APCDKDVR
...
PROCESS ;Get vars and process visit
 ...
 S DFN=$P(^AUPNVSIT(APCDKV,0),U,5) I DFN="",$P(^AUPNVSIT(APCDKV,0),U,2)]"",$P(^AUPNVSIT(APCDKV,0),U,2)'=DT,$$NOVFILES(APCDKV) S DA=APCDKV,DIK="^AUPNVSIT(" D ^DIK ;delete visits with no patient
...
RELINK ;repoint v file entry
 ;W !,"Would have relinked ",APCDKVFL," ",APCDVDFN," to visit ",APCDKXVS Q
