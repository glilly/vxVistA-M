APCDEGPP ; IHS/CMI/TUCSON - NO DESCRIPTION PROVIDED ; [ 02/15/00  11:00 AM ]
...
DATE I $Y>(IOSL-6) D FF Q:APCDQUIT
 ...
 . W ?49,$S($P(^DD(9000010.06,.01,0),U,2)[200:$P(^VA(200,Y,0),U),1:$P(^DIC(16,Y,0),U))
 ...
 . W:C ! W ?49,$S($P(^DD(9000010.06,.01,0),U,2)[200:$P(^VA(200,$P(^AUPNVPRV(APCDX,0),U),0),U),1:$P(^DIC(16,$P(^AUPNVPRV(APCDX,0),U),0),U))
 . Q
...
MEAS ;
 ...
 . W:C ! W ?18,$P(^AUTTMSR(Y,0),U),?23,$P(^AUPNVMSR(X,0),U,4)
 . S C=C+1 Q
 W !,$TR($J("",80)," ","_")
LABS ;
...
PROC ;
 ...
 . W:C ! W ?16,$P(^ICD0(Y,0),U),?25,$P(^AUTNPOV($P(^AUPNVPRC(X,0),U,4),0),U)
 . S C=C+1 Q
IMM ;
