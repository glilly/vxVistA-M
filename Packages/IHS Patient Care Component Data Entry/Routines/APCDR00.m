...
PRIPRV ; 
 I $P(^DD(9000010.06,.01,0),U,2)[200 D PRI200 Q  ;IHS/CMI/LAB PATCH 1 FOR FILE 200 CONVERSION SITES
 S (APCDPDIS,APCDX,APCDPAFF,APCDPCOD,APCDY)=""
 I $G(^DIC(6,APCDPPRV,9999999))="" S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E002" D ERR,EOJ Q
 S APCDPAFF=$P(^DIC(6,APCDPPRV,9999999),U) I APCDPAFF="" S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E028" D ERR,EOJ Q
 S APCDY=$P(^DIC(6,APCDPPRV,0),U,4)
 I APCDY="" S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E027" D ERR,EOJ Q
 I '$D(^DIC(7,APCDY,9999999)) S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E027" D ERR,EOJ Q
 S APCDPDIS=$P(^DIC(7,APCDY,9999999),U) I APCDPDIS="" S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E027" D ERR,EOJ Q
 S APCDPCOD=$P(^DIC(6,APCDPPRV,9999999),U,2)
 I APCDPCOD="" S APCDE("FILE")=9000010.06,APCDE("ENTRY")=APCDAP,APCDE="E002" D ERR,EOJ Q
 S APCDL=$L(APCDPCOD)+1 F APCDLL=APCDL:1:3 S APCDPCOD=APCDPCOD_" "
 S APCDPPRV=APCDPAFF_APCDPDIS_APCDPCOD
 D EOJ
 Q
CHECKPV ; 
