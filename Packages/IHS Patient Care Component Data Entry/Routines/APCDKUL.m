APCDKUL ; IHS/CMI/TUCSON - NO DESCRIPTION PROVIDED ; [ 01/03/03  3:08 PM ]
 ;;2.0;IHS RPMS/PCC Data Entry;**2,3,5,6**;MAR 09, 1999
 ;
...
GETVFILE ;
 ...
 F APCDJ=1:1:12 S APCDX=$P($T(MENU+APCDJ),";;",2) W !?10,APCDJ,")  ",APCDX
 K APCDX,APCDJ,APCDTEXT
 S DIR(0)="N^1:12:0",DIR("A")="Choose WHICH DATA ITEM TO MOVE",DIR("B")="12" D ^DIR K DIR S:$D(DUOUT) DIRUT=1
 Q:$D(DIRUT)
 Q:Y=12
