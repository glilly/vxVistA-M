...
EN2 S ORDER=0 F  S ORDER=$O(ORES(ORDER)) Q:ORDER'>0  D
 ...
 . .;DSS/RAF -BEGIN MODS - ORDER GROUP ID call
 . I $P(ORA0,U,2)="NW",OROLDSTS=11,$P(OR0,U,14)=ORLAB,$G(^OR(100,ORIFN,4)) W !,$$ORDITEM^ORCACT(ORIFN)_"  (LB #"_+^OR(100,ORIFN,4)_")" S ORWAIT=1 D
 . .N VFDDATA,VFDORID
 . .S VFDDATA(1)=ORIFN
