ORQQPL3 ; ALB/PDR/REV - Problem List RPCs ;11/19/09  10:15
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,148,173,243,280**;Dec 17, 1997;Build 7
 ;
...
LIST(GMPL,GMPDFN,GMPSTAT)       ; -- Returns list of problems for patient GMPDFN
 ...
 . ;DSS/SGM - BEGIN MODS add vxvista fields (21600.xx) to return string
 . I $G(^%ZOSF("ZVX"))["VX" S LIN=LIN_U_$G(^AUPNPROB(IFN,21600))
 . ;DSS/SGM - END MODS
 . S GMPL(CNT)=LIN
 S GMPL(0)=CNT
 Q
...
DELLIST(RETURN,GMPDFN) ; GET LIST OF DELETED PROBLEMS
 ...
 ... ;DSS/SMP - BEGIN MODS add vxvista fields (21600.xx) to return string
 ... I $G(^%ZOSF("ZVX"))["VX" S RETURN(I)=RETURN(I)_U_$G(^AUPNPROB(IFN,21600))
 ... ;DSS/SMP - END MODS
 S RETURN(0)=I
 Q
 ;
