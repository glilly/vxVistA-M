RACTWR ; GENERATED FROM 'RA REPORT EDIT' INPUT TEMPLATE(#1069), FILE 74;09/24/03
 D DE G BEGIN
...
10 S DQ=11 ;@15
11 S D=0 K DE(1) ;100
 S DIFLD=100,DGO="^RACTWR1",DC="3^74.01DA^L^",DV="74.01RD",DW="0;1",DOW="LOG DATE",DLB="Select "_DOW S:D DC=DC_D
