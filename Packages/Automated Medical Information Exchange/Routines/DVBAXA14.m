...
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW=".11;12",DV="FXOaR",DU="",DLB="ZIP+4",DIFLD=.1112
 ...
 S DE(DW)="C2^DVBAXA14",DE(DW,"INDEX")=1
 G RE
...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".11;7",DV="NJ3,0XOaR",DU="",DLB="COUNTY",DIFLD=.117
 S DQ(3,2)="S Y(0)=Y Q:Y']""""  S Z0=$S($D(^DPT(D0,.11)):+$P(^(.11),""^"",5),1:"""") Q:'Z0  S Y=$P($S($D(^DIC(5,Z0,1,Y,0)):^(0),1:""""),""^"",3) S:$T(COUNTY^VFDCDPT)'="""" Y=$$COUNTY^VFDCDPT(Z0,Y(0))"
 S DE(DW)="C3^DVBAXA14"
 G RE
