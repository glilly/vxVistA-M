...
BEG ;
 ...
 . N LABO S LABO=1
 . ;DSS/SGM - BEG MODS - allow for vxversion number format
 . ;          original line now argument of "E  I"
 . I $G(^%ZOSF("ZVX"))["VX" D
 . . I '$$VALID^VFDI0000($P(LIN,";",3)) D E^XINDX1(44)
 . E  I $P(LIN,";",3,99)'?1.2N1"."1.2N.1(1"T",1"V").2N1";".E D E^XINDX1(44) ;patch 121
 . ;DSS/SGM - END MODS
